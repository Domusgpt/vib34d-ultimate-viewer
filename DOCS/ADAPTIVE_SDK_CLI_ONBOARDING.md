...
2. Use `status`, `plugins list`, and `commands list` after each change to verify
   activation.
3. Review `DOCS/PLUGINS_QUICKSTART.md` for deep dives into the descriptor model
   and marketplace integration.
4. Share your config and onboarding notes with your agents to ensure consistent
