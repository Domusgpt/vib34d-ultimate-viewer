...
- ✅ **Curated attestation catalog** – Published `DOCS/LICENSE_ATTESTATION_PROFILE_CATALOG.md` and `src/product/licensing/attestationProfiles/defaultProfiles.js` so enterprise, healthcare, and creator defaults seed the registry automatically.
