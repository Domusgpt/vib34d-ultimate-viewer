...
- `src/product/licensing/LicenseAttestationAnalytics.js` aggregates attestation/validation/error counts per pack/profile, tracks history, and feeds the SDK/UI with commercialization metrics and exportable attestation reports for consent-compliant reporting.【F:src/product/licensing/LicenseAttestationAnalytics.js†L1-L476】
