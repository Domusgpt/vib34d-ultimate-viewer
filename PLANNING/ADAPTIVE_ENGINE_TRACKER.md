...
| B-13 | License attestation pipeline | Integrate remote validation, revocation checks, and entitlement sync for the license manager. | Core Team | Planned | Phase 2 |
...
- **License validation maturity:** Local license checks land in this iteration; remote attestation and entitlement sync remain open (tracked in B-13).
