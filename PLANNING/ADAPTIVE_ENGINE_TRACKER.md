...
| 2025-10-25 | B-17 | Headless environment bootstrap delivered: engine/gallery/export gating, SDK `environment` config, type updates, and headless Vitest coverage unblock CI/partner automation. | Add injectable visualizer facades + headless demo modules to B-05 and document environment guidelines in README/test playbooks. |
