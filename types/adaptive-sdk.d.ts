...
export interface LicenseAttestationAnalyticsCounters {
  attestations: number;
  validations: number;
  revocations: number;
  entitlements: number;
...
export interface LicenseAttestationAnalyticsEventDetail {
  timestamp: string | null;
  details: Record<string, unknown> | null;
}

export interface LicenseAttestationAnalyticsProfileSummary {
  id: string;
  name: string;
  description: string;
  metadata: Record<string, unknown> | null;
  sla: LicenseAttestationProfileSLA | null;
  packId: string | null;
  counts: LicenseAttestationAnalyticsCounters;
  lastEvents: Record<string, LicenseAttestationAnalyticsEventDetail>;
  lastEventAt: string | null;
}

export interface LicenseAttestationAnalyticsPackSummary {
  id: string;
  name: string;
  description: string;
  metadata: Record<string, unknown> | null;
  totals: LicenseAttestationAnalyticsCounters;
  lastEventAt: string | null;
  defaultProfileId: string | null;
  profiles: LicenseAttestationAnalyticsProfileSummary[];
}

export interface LicenseAttestationAnalyticsHistoryEntry {
  event: string;
  timestamp: string | null;
...
export interface LicenseAttestationAnalyticsDerivedMetrics {
  successRate: number;
  errorRate: number;
  attestationCoverage: number;
  revocationRate: number;
  entitlementRefreshRate: number;
  scheduleRate: number;
  totalSignals: number;
}

export interface LicenseAttestationAnalyticsSummary {
  totalPacks: number;
  ...
  lastEventAt: string | null;
  overall: LicenseAttestationAnalyticsCounters;
  packs: LicenseAttestationAnalyticsPackSummary[];
  standaloneProfiles: LicenseAttestationAnalyticsProfileSummary[];
  recentHistory: LicenseAttestationAnalyticsHistoryEntry[];
}

export interface LicenseAttestationAnalyticsReport {
  generatedAt: string;
  scope: {
    packId: string | null;
  ...
  totals: LicenseAttestationAnalyticsCounters;
  derivedMetrics: LicenseAttestationAnalyticsDerivedMetrics;
  pack: LicenseAttestationAnalyticsPackSummary | null;
  profile: LicenseAttestationAnalyticsProfileSummary | null;
  history: LicenseAttestationAnalyticsHistoryEntry[];
  overall: LicenseAttestationAnalyticsCounters;
}

export interface LicenseAttestationAnalyticsReportOptions {
  packId?: string | null;
  profileId?: string | null;
...
export type LicenseAttestationAnalyticsExportFormat = 'json' | 'object';

export interface LicenseAttestationAnalyticsExportOptions
  extends LicenseAttestationAnalyticsReportOptions {
  format?: LicenseAttestationAnalyticsExportFormat;
  pretty?: boolean;
}
...
export interface LicenseAttestationProfileRegistrationContext {
  packId?: string;
  packName?: string;
  packDescription?: string;
  packMetadata?: Record<string, unknown>;
  isDefault?: boolean;
}
...
export interface AdaptiveSDK {
  ...
  registerLicenseAttestationProfile(
    ...
    context?: LicenseAttestationProfileRegistrationContext
  ...
  getLicenseAttestationAnalytics(): LicenseAttestationAnalyticsSummary;
  getLicenseAttestationAnalyticsReport(
    options?: LicenseAttestationAnalyticsReportOptions
  ): LicenseAttestationAnalyticsReport;
  exportLicenseAttestationAnalyticsReport(
    options?: LicenseAttestationAnalyticsExportOptions
  ): string | LicenseAttestationAnalyticsReport;
