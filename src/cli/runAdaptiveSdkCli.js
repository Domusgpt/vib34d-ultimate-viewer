...
function renderInit(stdout) {
    ...
    stdout.write('5. Run `node bin/adaptive-sdk-cli.js guide` to share highlights and next steps.\n');
    stdout.write('6. Keep tests green with `npm test` to exercise CLI + SDK integration.\n\n');
