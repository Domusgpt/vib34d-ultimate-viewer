...
} from './licensing/attestationProfiles/defaultProfiles.js';
...
export class ProductTelemetryHarness {
    constructor(options = {}) {
        ...
        const useDefaultProfiles = options.useDefaultLicenseAttestationProfiles ?? true;
        if (useDefaultProfiles) {
            registerDefaultLicenseAttestationProfiles(this.licenseAttestationProfiles, {
                setDefault: !options.defaultLicenseAttestationProfileId,
                defaultProfileId:
                    options.defaultLicenseAttestationProfileId || DEFAULT_LICENSE_ATTESTATION_PROFILE_ID,
                profileIds: options.seedLicenseAttestationProfileIds,
                overrideExisting: options.overrideSeedLicenseAttestationProfiles ?? true
            });
        }
