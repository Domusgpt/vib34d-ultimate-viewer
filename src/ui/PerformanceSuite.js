    ...
    mountLayout() {
        ...
        this.root.innerHTML = `
            ...
            <div class="performance-suite__columns">
                ...
                <section class="performance-suite__column performance-suite__column--presets"></section>
            </div>
        `;
        ...
        this.presetsContainer = this.root.querySelector('.performance-suite__column--presets');
    }

    initModules() {
        if (!this.touchpadContainer || !this.audioContainer || !this.presetsContainer) {
            return;
        }
