...
export function createAdaptiveSDK(config = {}) {
    ...
    const engine = new AdaptiveInterfaceEngine({
        ...
        blueprintInsights: config.blueprintInsights,
        blueprintScenarios: config.blueprintScenarios,
        blueprintCalibration: config.blueprintCalibration
    });
    ...
    return {
        ...
        generateLayoutBlueprintSnapshot: engine.generateLayoutBlueprintSnapshot.bind(engine),
        generateLayoutBlueprintScenario: engine.generateLayoutBlueprintScenario.bind(engine),
        runLayoutBlueprintEvolution: engine.runLayoutBlueprintEvolution.bind(engine),
        calibrateLayoutBlueprint: engine.calibrateLayoutBlueprint.bind(engine),
        getLayoutBlueprintInsightHistory: engine.getBlueprintInsightHistory.bind(engine),
        clearLayoutBlueprintInsightHistory: engine.clearBlueprintInsightHistory.bind(engine),
        getLayoutBlueprintScenarioHistory: engine.getBlueprintScenarioHistory.bind(engine),
        clearLayoutBlueprintScenarioHistory: engine.clearBlueprintScenarioHistory.bind(engine),
        getLayoutBlueprintCalibrationHistory: engine.getBlueprintCalibrationHistory.bind(engine),
        clearLayoutBlueprintCalibrationHistory: engine.clearBlueprintCalibrationHistory.bind(engine),
        getLayoutBlueprintEvolutionHistory: engine.getBlueprintEvolutionHistory.bind(engine),
        clearLayoutBlueprintEvolutionHistory: engine.clearBlueprintEvolutionHistory.bind(engine),
        ...
        get blueprintInsightEngine() {
            return engine.getBlueprintInsightEngine();
        },
        get blueprintCalibrationEngine() {
            return engine.getBlueprintCalibrationEngine?.() || null;
        }
    };
}
