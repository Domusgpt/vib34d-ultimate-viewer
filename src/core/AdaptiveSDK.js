...
export function createAdaptiveSDK(config = {}) {
    ...
    if (Array.isArray(config.seedLicenseAttestationProfileIds)) {
        telemetryOptions.seedLicenseAttestationProfileIds = config.seedLicenseAttestationProfileIds;
    }
    if (typeof config.overrideSeedLicenseAttestationProfiles === 'boolean') {
        telemetryOptions.overrideSeedLicenseAttestationProfiles = config.overrideSeedLicenseAttestationProfiles;
    }
    if (config.useDefaultLicenseAttestationProfiles === false) {
        telemetryOptions.useDefaultLicenseAttestationProfiles = false;
    }
