...
export function createAdaptiveSDK(config = {}) {
    ...
    const pluginApi = {
        ...
        registerMany: pluginManager.registerMany,
        unregister: pluginManager.unregister,
        get: pluginManager.get,
        list: pluginManager.list,
        watch: pluginManager.watch,
        whenRegistered: pluginManager.whenRegistered,
        whenReady: pluginManager.whenReady,
        listCommands: pluginManager.listCommands,
        getCommand: pluginManager.getCommand,
        invokeCommand: pluginManager.invokeCommand,
        listAgents: pluginManager.listAgents,
        getAgent: pluginManager.getAgent,
        createAgent: pluginManager.createAgent,
        emitHook: pluginManager.emitHook,
        listHooks: pluginManager.listHooks,
        listServers: pluginManager.listServers,
        getServer: pluginManager.getServer,
        createServer: pluginManager.createServer,
        registerMarketplace: pluginManager.registerMarketplace,
        unregisterMarketplace: pluginManager.unregisterMarketplace,
        getMarketplace: pluginManager.getMarketplace,
        listMarketplaces: pluginManager.listMarketplaces,
        installFromMarketplace: pluginManager.installFromMarketplace
    };
    ...
    const sdk = {
        ...
        licenseAttestor,
        plugins: pluginApi,
        watchPlugins: pluginApi.watch,
        registerPlugin: pluginApi.register,
        registerPlugins: pluginApi.registerMany,
        unregisterPlugin: pluginApi.unregister,
        getPlugin: pluginApi.get,
        listPlugins: pluginApi.list,
        whenPluginsReady: pluginApi.whenReady,
        whenPluginRegistered: pluginApi.whenRegistered,
        listPluginCommands: pluginApi.listCommands,
        getPluginCommand: pluginApi.getCommand,
        invokePluginCommand: pluginApi.invokeCommand,
        listPluginAgents: pluginApi.listAgents,
        getPluginAgent: pluginApi.getAgent,
        createPluginAgent: pluginApi.createAgent,
        emitPluginHook: pluginApi.emitHook,
        listPluginHooks: pluginApi.listHooks,
        listPluginServers: pluginApi.listServers,
        getPluginServer: pluginApi.getServer,
        createPluginServer: pluginApi.createServer,
        registerPluginMarketplace: pluginApi.registerMarketplace,
        unregisterPluginMarketplace: pluginApi.unregisterMarketplace,
        listPluginMarketplaces: pluginApi.listMarketplaces,
        getPluginMarketplace: pluginApi.getMarketplace,
        installPluginFromMarketplace: pluginApi.installFromMarketplace,
    ...
    pluginManager.registerMarketplacesFromConfig(config.pluginMarketplaces);
    const pluginBootstrapPromise = pluginManager.registerFromConfig(config.plugins);
    if (pluginBootstrapPromise && typeof pluginBootstrapPromise.then === 'function') {
        pluginBootstrapPromise.catch((error) => {
            console.warn('[AdaptiveSDK] Failed to register plugins from config', error);
        });
    }
