...
export function createAdaptiveSDK(config = {}) {
    ...
    return {
        ...
        getLicenseAttestationAnalytics: engine.getLicenseAttestationAnalytics.bind(engine),
        getLicenseAttestationAnalyticsReport: engine.getLicenseAttestationAnalyticsReport.bind(engine),
        exportLicenseAttestationAnalyticsReport: engine.exportLicenseAttestationAnalyticsReport.bind(engine),
