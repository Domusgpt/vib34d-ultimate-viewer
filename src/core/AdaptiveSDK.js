...
export function createAdaptiveSDK(config = {}) {
    ...
    if (Array.isArray(config.projectionChannels)) {
        if (config.replaceDefaultProjectionChannels ?? false) {
            engine.clearProjectionChannels();
        }
        for (const channel of config.projectionChannels) {
            engine.registerProjectionChannel(channel);
        }
    }
    ...
    return {
        ...
        projectionScenarioSimulator: engine.projectionScenarioSimulator,
        licenseManager,
        licenseAttestor,
        ...
        registerProjectionChannel: engine.registerProjectionChannel.bind(engine),
        clearProjectionChannels: engine.clearProjectionChannels.bind(engine),
        registerProjectionScenario: engine.registerProjectionScenario.bind(engine),
        clearProjectionScenarios: engine.clearProjectionScenarios.bind(engine),
        listProjectionScenarios: engine.listProjectionScenarios.bind(engine),
        simulateProjectionScenario: engine.simulateProjectionScenario.bind(engine),
        ...
        getProjectionBlueprint: engine.getProjectionBlueprint.bind(engine),
        getAdaptiveContextSnapshot: engine.getAdaptiveContextSnapshot.bind(engine),
        getActiveLayout: engine.getActiveLayout.bind(engine),
