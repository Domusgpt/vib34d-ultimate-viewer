...
export class AdaptiveInterfaceEngine extends VIB34DIntegratedEngine {
    ...
    getLicenseAttestationAnalytics() {
        return this.telemetry.getLicenseAttestationAnalyticsSummary();
    }

    getLicenseAttestationAnalyticsReport(options = {}) {
        return this.telemetry.getLicenseAttestationAnalyticsReport(options);
    }

    exportLicenseAttestationAnalyticsReport(options = {}) {
        return this.telemetry.exportLicenseAttestationAnalyticsReport(options);
    }
