...
- Automated testing for the adaptive pipeline is being retooled around Vitest + jsdom (Phase 1) with optional Playwright smoke suites—see the tracker for adoption status.
